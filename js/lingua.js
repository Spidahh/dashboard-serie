...
const DIZIONARIO = {
  ...
  'home.guardaEsempio':  ['guarda l\'esempio', 'see the example'],
  ...
  'bad.seguito':         ['SEGUITO', 'SEQUEL'],
  'bad.esempioData':     ['tra 3 giorni', 'in 3 days'],
  'bad.quanteAiuto':     ['Quanti dei tuoi titoli lo consigliano', 'How many of your titles recommend it'],
  'bad.escoAiuto':       ['Quando esce', 'When it comes out'],
  'bad.uscitoAiuto':     ['Quand\'è uscito', 'When it came out'],
  'bad.filmVistoAiuto':  ['L\'hai già visto', 'You have already watched it'],
